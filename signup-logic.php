    ...
    //echo $firstname, $lastname, $username, $email, $createpassword, $confirmpassword;
          ...
          if (mysqli_num_rows($user_check_result) > 0) {
           ...
           //rename avatar
            ...
            if(in_array($extention, $allowed_files)){
                ...
                $_SESSION['signup']= "File must be png, jpg, jpeg or heic";
            }
         }
     ...
     // redirect back to signup page if there was any problem
            if(isset($_SESSION['signup'])){
                ...
                VALUES('$firstname', '$lastname', '$username', '$email', '$hash_pwd', '$avatar_name', 0)" ;
                $insert_user_result = mysqli_query($connection, $insert_user_query);
                
                if(!mysqli_errno($connection)) {
                    //redirect to login page with your registration successful
                    $_SESSION['signup-successful'] = "Registration succssful, please login";
